...
public class EncryptedFile implements Serializable {
   ...
   */
  public EncryptedFile(String cipherText, byte[] nonce, byte[] salt) {
   ...
   * @param pbkdf2Scheme
   */
  private EncryptedFile(String cipherText, byte[] nonce, byte[] salt, String cipher, String cipherscheme, int gcmAuthenticationTagSizeBits, int gcmIvNonceSizeBytes, int pbkdf2Iterations, int pbkdf2SaltSizeBytes, int aesKeyLengthBits, String pbkdf2Scheme) {
    this.cipherText = cipherText;
    this.nonce = nonce;
    this.salt = salt;
   ...
   */
  public EncryptedFile encrypt(String plainText, String password) throws GeneralSecurityException {
    /* Derive the key*/
    ...
    return new EncryptedFile(new String(Base64.getEncoder().encode(byteCipher)), newNonce, newSalt, this.cipher, cipherscheme, gcmAuthenticationTagSizeBits, gcmIvNonceSizeBytes, pbkdf2Iterations, pbkdf2SaltSizeBytes, aesKeyLengthBits, pbkdf2Scheme);
  }
